...
export default function AdminReviewsPage() {
  ...
  const { data: eventsData, isLoading: eventsLoading } = useListEventsQuery({ page: 0, size: 200 });
  const allEvents: any[] = Array.isArray(eventsData?.content)
    ? eventsData.content
  ...
  // Events that have reviews, filtered by search, sorted by most reviews
  ...
  const avgRatingsData = [
    ...
    { name: "Vendor Service", value: selectedSummary?.avgVendorRating ?? 0 },
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="font-body text-dark-gray">
            Platform-wide feedback insights and showcase management
          </p>
        </div>
              ...
              <Card hover={false} padding="lg">
                <div className="py-16 text-center">
                  ...
                  <p className="font-body text-sm text-muted-gray max-w-xs mx-auto">
                    Choose an event from the list to view its review analytics and manage showcase settings.
                  </p>
                </div>
              </Card>
            ) : (
                            ...
                            <div className="flex-1 min-w-0 space-y-2">
                              <div className="flex flex-wrap gap-4">
                                {[
                                  ...
                                  { label: "Vendor", value: r.vendorRating, comment: r.vendorComment },
